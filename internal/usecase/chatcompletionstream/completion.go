...
import (
	...
	"github.com/rodrigonpaiva/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	assistantMessage, err := entity.NewMessage("assistant", fullResponse.String(), chat.Config.Model)
	if err != nil {
		return nil, errors.New("error creating assistant message" + err.Error())
	}
	err = chat.AddMessage(assistantMessage)
	if err != nil {
...
func createNewChat(input ChatCompletionInputDTO) (*entity.Chat, error) {
	...
	if err != nil {
		return nil, errors.New("error creating chat entity" + err.Error())
	}
	return chat, nil
}
